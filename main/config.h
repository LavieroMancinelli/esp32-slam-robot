...
#define SPIKE_THRESHOLD 75 // mm between points is considered a spike
...
#define POINT_NEIGHBORHOOD_SIZE 4 // number of relevant points on each side of current point to calculate tangent line
