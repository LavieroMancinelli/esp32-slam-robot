...
#define MAP_RATIO 5 // cell represents this number mm^2
...
#define MAX_DISTANCE_PER_ITERATION 5000 // maximum distance a corresponding point can be apart from its pair *NOTE* must be large to accomodate pairs for rot matching before T
...
#define DEADRECKON_T_WEIGHT 0.5 // weight of deadreckoning estimation vs icp in translation computation
#define DEADRECKON_ROT_WEIGHT 0.5 // weight of deadreckoning estimation vs icp in rotation computation
#define ICP_TURN_SCALAR 1.0 // scalar on ICP T values during pure rotation, < 1 to reduce parallel wall error
#endif